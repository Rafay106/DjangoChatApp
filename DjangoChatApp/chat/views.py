...
def homeView(request):
    ...
    context = {"rooms": rooms, "topics": topics, "msgs": msgs}
...
def roomView(request, pk):
    ...
    context = {
        ...
        "groupName": str(room.id) + "-" + room.name,
    }
...
def userProfileView(request, uname):
    ...
    context = {"user": user, "rooms": rooms, "topics": topics, "msgs": msgs}
...
def createView(request):
    ...
    context = {"form": form, "f_title": "Create Room", "topics": topics}
...
def updateView(request, pk):
    ...
    context = {"form": form, "f_title": f_title, "topics": topics, "room": room}
    return render(request, "chat/roomCreateForm.html", context)
